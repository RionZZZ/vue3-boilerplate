...
module.exports = {
  ...
  rules: {
    ...
    'quotes': ['warn', 'single'], // 要求统一使用单引号符号
    'vue/comment-directive': 'off', // html根文件报警
    'vue/max-attributes-per-line': ['warn', { singleline: 5, multiline: 2 }], // 要求每一行标签的最大属性不超五个
    // 取消关闭标签不能自闭合的限制设置
    ...
    'vue/multi-word-component-names': 'off', // 文件名驼峰规范关闭
    '@typescript-eslint/no-explicit-any': 'off', // 允许使用any
    '@typescript-eslint/no-unused-vars': ['error', { args: 'none' }] // 不允许var了不使用，允许参数声明了而不使用
  }
}
